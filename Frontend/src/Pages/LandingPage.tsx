...
const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d1110] overflow-hidden">
      {/* Hero Section */}
            ...
            <div className="flex justify-between items-center h-20">
              ...
              <div className="flex items-center space-x-4">
                {user ? (
                  <Link
                    to="/dashboard"
                    className="flex items-center space-x-2 bg-emerald-600 text-white px-6 py-2.5 rounded-xl hover:shadow-md hover:shadow-none transition-all text-sm font-semibold"
                  >
                    <span>Dashboard</span>
            ...
            >
              ...
              >
                <Link
                  ...
                  className="group inline-flex items-center justify-center space-x-2 bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-base hover:shadow-md hover:shadow-none transition-all duration-300"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-zinc-100 mb-6">
              ...
              <span className="text-emerald-400">Get Hired</span>
            </h2>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="glass-card rounded-lg p-8 h-full">
                  <div
                    className={`w-12 h-12 rounded-xl bg-emerald-600 flex items-center justify-center mb-6 transition-transform duration-300 shadow-lg`}
                  >
      ...
      >
        {/* Background glow */}
        <div className="absolute inset-0">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] hidden" />
        </div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card rounded-xl p-12 md:p-16 text-center">
            ...
            >
              Ready to{" "}
              <span className="text-emerald-400">Elevate Your Career?</span>
            </motion.h2>
            <motion.p
            ...
            >
              <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                <Link
                  to={user ? "/dashboard" : "/register"}
                  className="group inline-flex items-center justify-center space-x-2 bg-emerald-600 text-white px-10 py-4 rounded-xl font-semibold text-lg hover:shadow-md hover:shadow-none transition-all duration-300"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              ...
              <span className="text-sm font-semibold text-emerald-400">ElevateCv</span>
            </div>
